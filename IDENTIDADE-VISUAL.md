...
## Paleta de marca (distinta da paleta funcional do Design System)

Esta é a paleta da **marca/identidade** (ícone, splash, telas de
login/onboarding) — NÃO substitui a paleta funcional do `tokens.ts` usada
dentro do app (azul primário, verde receita, vermelho despesa continuam
como estão, definidos em REFATORACAO-UI.md). São dois sistemas de cor com
propósitos diferentes: marca é preto+dourado; produto/UI continua a paleta
já auditada no Item 1 do BACKLOG-UX-e-lancamento.md.

| Uso | Cor | HEX |
|---|---|---|
| Fundo de marca (ícone, splash) | Preto | `#0B0B0D` |
| Porquinho (topo do gradiente) | Amarelo | `#FFD84D` |
| Porquinho (base do gradiente) | Amarelo escuro | `#F5B800` |
| Moeda (topo do gradiente) | Dourado claro | `#FFE27A` |
| Moeda (base do gradiente) | Dourado escuro | `#E8A63B` |
| Contorno da moeda | Marrom dourado | `#B8860B` |
| Texto do wordmark "Cofrin" | Amarelo | `#FFD84D` |
| Texto da tagline | Cinza claro | `#9CA3AF` |
...
<svg width="1024" height="1024" viewBox="0 0 180 180" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect width="180" height="180" rx="40" fill="#0B0B0D"/>
  ...
  <ellipse cx="90" cy="104" rx="18" ry="13" fill="#0B0B0D" opacity="0.85"/>
  <circle cx="83" cy="104" r="3" fill="#FFD84D"/>
  <circle cx="97" cy="104" r="3" fill="#FFD84D"/>
  <circle cx="65" cy="88" r="4" fill="#0B0B0D"/>
  <circle cx="66.3" cy="86.7" r="1.2" fill="#FFFFFF"/>
  <rect x="80" y="66" width="20" height="6" rx="3" fill="#0B0B0D"/>
...
<svg width="340" height="120" viewBox="0 0 340 120" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(10,10)">
    ...
    <ellipse cx="50" cy="58" rx="10" ry="7.5" fill="#000000" opacity="0.85"/>
    <circle cx="46" cy="58" r="1.7" fill="#FFD84D"/>
    <circle cx="54" cy="58" r="1.7" fill="#FFD84D"/>
    <circle cx="36" cy="48" r="2.3" fill="#000000"/>
    <rect x="44" y="36" width="12" height="3.5" rx="1.75" fill="#000000"/>
...
fundo `#0B0B0D` sólido, sem o wordmark (padrão de splash screen moderno:
...
2. **Atualizar `app.json`:**
   ...
   - `expo.splash.image` / `expo.splash.backgroundColor`: `"#0B0B0D"`
