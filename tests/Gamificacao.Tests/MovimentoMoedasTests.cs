...
public class MovimentoMoedasTests
{
    ...
    {
        Assert.Throws<ArgumentException>(() => new MovimentoMoedas(Guid.NewGuid(), 0, TipoMovimento.Credito, "motivo", Guid.NewGuid()));
    }
    ...
    public void Criar_ComDadosValidos_DevePreencherPropriedades()
    {
        ...
        var movimento = new MovimentoMoedas(eventId, 5, TipoMovimento.Credito, "Despesa registrada", Guid.NewGuid());
