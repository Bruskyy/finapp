...
const ITENS: ItemDrawer[] = [
  ...
  { rota: "Categorias", label: "Categorias", icone: "pricetags-outline" },
  { rota: "Análise", label: "Análise", icone: "stats-chart-outline" },
  { rota: "Compras detectadas", label: "Compras detectadas", icone: "flash-outline" },
